                                            ...
                                            <div class="single-product-wrap">
                                                <div class="product-image">
                                                    <a href="{{ URL::to('products/' . $product->id) }}">
                                                        <img src="images/product/large-size/{{ $product->id }}.jpg" alt="{{ $product->name }}">
                                                    </a>
                                                    <span class="sticker">New</span>
                                                </div>
                                                <div class="product_desc">
                                                    <div class="product_desc_info">
                                                        ...
                                                        <h4><a class="product_name" href="{{ URL::to('products/' . $product->id) }}">{{ $product->name }}</a></h4>
                                                        <div class="price-box">
                                                            <span class="new-price">${{mt_rand(45, 150)}}</span>
                                                        </div>
                                                    </div>
                                                    <div class="add-actions">
                                                        <ul class="add-actions-link">
